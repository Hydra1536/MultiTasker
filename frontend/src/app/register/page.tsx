        ...
        <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <section className="flex flex-col justify-between rounded-[2rem] border border-white/70 bg-slate-950 p-8 text-white shadow-[0_30px_80px_-35px_rgba(15,23,42,0.7)]">
            <div className="space-y-4">
              ...
              <h2 className="max-w-md text-4xl font-semibold leading-tight">Create your workspace and start annotating and planning.</h2>
              <p className="max-w-md text-sm text-slate-300">
                Registration is email-based and uses Django password validators on the backend.
              </p>
            </div>
            <p className="mt-12 text-sm text-slate-400">
              Already have an account? <Link href="/login" className="font-medium text-white underline underline-offset-4">Sign in</Link>
            </p>
          </section>
